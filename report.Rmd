...
As shown above, manipulation of the rounding method and parameters yielded a **final un-rounded rating RMSE of `r round(mean_umgR_RMSE, digits=3)`** and **rounded rating accuracy of `r round(max(optimistAcc), digits=3)`** on the test set.  While this accuracy does not meet the minimum threshold of 0.50 established in the original evaluation rubric for the project, it is a significant improvement over the initial model as used in the course.
